...
if __name__ == '__main__':
    ...
    def test_DefineShape_load():
        s = b'\xbf\x00$\x00\x00\x00\x01\x00`\x002\x00\x00\r\xc0\x01\x00\xff\xff\xff\x01\x01\x00\x00\x00\x00\x115\x8c\x807\x1fD\xe0p\xc9\x1d\x0c\x81\xc2\xdc\x00'
    ...
    def test_SHAPEWITHSTYLE_load():
        global a
        s = b'\x01\x00\xff\xff\xff\x01\x01\x00\x00\x00\x00\x115\x8c\x807\x1fD\xe0p\xc9\x1d\x0c\x81\xc2\xdc\x00'
        print(repr(s[0xc:]))
        ptypes.setsource( prov.string(s) )
