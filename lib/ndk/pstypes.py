...
class _Win32kCallbackTable(pstruct.type, versioned):
    def __init__(self, **attrs):
        super(_Win32kCallbackTable, self).__init__(**attrs)
        self._fields_ = f = []
        ...
        if sdkddkver.NTDDI_MAJOR(self.NTDDI_VERSION) >= sdkddkver.NTDDI_WIN7:
            f.extend([
                ...
                (PVOID, '__ClientCallDummyCallback'),
                (PVOID, '__fnKEYBOARDCORRECTIONCALLOUT'),
                (PVOID, '__fnOUTLPCOMBOBOXINFO'),
                (PVOID, '__fnINLPCOMPAREITEMSTRUCT2'),
                (PVOID, '__xxxClientCallDevCallbackCapture'),
                ...
                (PVOID, '__ClientWOWGetProcModule'),
                (PVOID, '__ClientWOWTask16SchedNotify'),
