...
class RT_VERSION(pstruct.type):
    def __Type(self):
        ...
        return RT_VERSION_ValueType.lookup(key, dyn.clone(RT_VERSION_ValueType.default, type=key, length=sz))
    ...
    def __ChildType(self):
        ...
        #return RT_VERSION_EntryType.lookup(szkey, dyn.clone(RT_Version_EntryType.default, type=szkey, length=bs))
