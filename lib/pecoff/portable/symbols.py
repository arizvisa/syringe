...
class Symbol(pstruct.type):
    ...
    def summary(self, **options):
        if self.initializedQ():
            ...
            res = sym_class.int()
            aux = AuxiliaryRecord.lookup(res, dyn.clone(AuxiliaryRecord.default, type=res))
...
class SymbolTable(parray.terminated):
    ...
    def isTerminator(self, value):
        if isinstance(value, Symbol):
            ...
            auxSymbol = AuxiliaryRecord.lookup(value, dyn.clone(AuxiliaryRecord.default, type=value))
